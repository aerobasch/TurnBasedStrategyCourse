...
public class Pathfinding : MonoBehaviour
{
    ...
    public List<GridPosition> FindPath(GridPosition startGridPosition, GridPosition endGridPostion,out int pathLength)
    {
        List<PathNode> openList= new List<PathNode>();
        List<PathNode> closedList = new List<PathNode>();

        PathNode startNode = GetGridsystem(startGridPosition.floor).GetGridObject(startGridPosition);
        PathNode endNode = GetGridsystem(endGridPostion.floor).GetGridObject(endGridPostion);
        ...
        startNode.SetHCost(CalculateDistance(startGridPosition,endGridPostion));
        ...
        while (openList.Count > 0) 
        {
            ...
            foreach(PathNode neighbourNode in GetNeighbourList(currentNode))
            {
                ...
                if (tentativeGcost < neighbourNode.GetGCost())
                {
                    ...
                    neighbourNode.SetHCost(CalculateDistance(neighbourNode.GetGridPosition(), endGridPostion));
